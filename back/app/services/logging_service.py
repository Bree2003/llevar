...
def _query_logs(query: str, limit: int):
    ...
    """
    print(f"CACHE MISS: Realizando llamada a la API de GCP para la query='{query}' y limit={limit}")
    
    entries = logging_client.list_entries(order_by=DESCENDING, filter_=query, page_size=limit)
    logs = []
