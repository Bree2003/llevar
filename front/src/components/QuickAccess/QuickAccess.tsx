export default function QuickAccess() {
  return (
    <div className="w-[420px] bg-[--color-gris-claro] p-5 text-left">
      ...
      <div className="p-2 bg-white rounded-xl flex flex-col gap-2">
        <p className="hover:bg-[--color-gris-claro] leading-none">Carga Avisos <br />
        <span className="text-sm text-[--color-gris-oscuro]">Fecha: 21/08/2025 14:35 hrs</span></p>
        <p className="hover:bg-[--color-gris-claro] leading-none">Maestro Fert <br />
        <span className="text-sm text-[--color-gris-oscuro]">Fecha: 21/08/2025 14:35 hrs</span></p>
        <p className="hover:bg-[--color-gris-claro] leading-none">Merma Semanal <br />
        <span className="text-sm text-[--color-gris-oscuro]">Fecha: 21/08/2025 14:35 hrs</span></p>
        <p className="hover:bg-[--color-gris-claro] leading-none">Maestro Insumos <br />
        <span className="text-sm text-[--color-gris-oscuro]">Fecha: 21/08/2025 14:35 hrs</span></p>
        <p className="hover:bg-[--color-gris-claro] leading-none">Maestro OF <br />
        <span className="text-sm text-[--color-gris-oscuro]">Fecha: 21/08/2025 14:35 hrs</span></p>
      </div>
    </div>
  );
