...
const AdminScreen = () => {
    ...
    const handleSaveReport = (report: Report) => {
        ...
        const exists = reports.some((currentReport) => currentReport.id === reportToSave.id);
            ...
            <div className="max-w-5xl w-full">
                ...
                <div className="flex justify-between">
                    <p className="mt-6 text-lg font-medium max-w-4xl text-[--color-text-secondary]">
                        Aquí puedes agregar, editar, eliminar y auditar los reportes agregados.
                    </p>
                                ...
                                >
                                    ...
                                    <div className="space-y-4">
                                        <div>
                                            <label
                                                htmlFor="area-filter"
                                                className="block text-xs uppercase font-semibold text-[--color-text-muted] mb-2"
                                            >
                                                Área
                                            </label>
